...
export default {
  name: configFile.roles.systemMaster.name,
  slug: configFile.roles.systemMaster.slug,
  permissions: createPermissionList({
    ...
    'system.reports.developers.view': true,
    'system.reports.requestsMetrics.view': true,
    'system.reports.githubMetrics.view': true,
    'system.reports.railwayMetrics.view': true,
    'system.reports.logs.view': true,
  })
};
